...
RTTYDecoder::RTTYDecoder()
    : state(IDLE), samples_since_edge(0), samples_since_sync_point(0), bit_buffer(0), bit_count(0), is_figures_shift(false), buffer_idx(0), goertzel_mark_Q1(0), goertzel_mark_Q2(0), goertzel_space_Q1(0), goertzel_space_Q2(0), is_mark_detected(false), last_is_mark_detected(false), tone_update_counter(0) {
